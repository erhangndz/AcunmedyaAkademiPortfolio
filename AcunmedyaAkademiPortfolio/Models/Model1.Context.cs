...
namespace AcunmedyaAkademiPortfolio.Models
{
    ...
    public partial class DbAcunmedyaAkademiPortfolioEntities : DbContext
    {
        public DbAcunmedyaAkademiPortfolioEntities()
            : base("name=DbAcunmedyaAkademiPortfolioEntities")
        {
        }
